...
document.getElementById('return-btn').addEventListener('click', function() {
    ...
    document.getElementById('titulo-episodio').textContent = 'Mavros'; // Restablece al nombre del personaje
...
function cambiarEpisodio(numero) {
    ...
    document.getElementById('titulo-episodio').textContent = 'Episodio ' + numero; // Cambia el título del episodio
